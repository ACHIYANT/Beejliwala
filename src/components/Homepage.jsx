...
function Homepage() {
  return (
    ...
    >
      <Header />
      <div className="layout-container flex h-full grow flex-col px-4 sm:px-8 md:px-16 lg:px-40">
        <div className="flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] w-full">
            <div className="flex flex-col gap-6 px-4 py-10 md:flex-row md:gap-8">
              <div
              ...
              <div className="flex flex-col gap-6 md:w-1/2 md:justify-center">
                <div className="flex flex-col gap-2 text-left">
                  <h1 className="text-[#111418] text-3xl font-black leading-tight sm:text-4xl md:text-5xl">
                    Your One-Stop Solution for Professional Electrical Work
                  </h1>
                  <h2 className="text-[#111418] text-sm font-normal sm:text-base">
                    We provide high-quality electrical work for commercial and
                    residential projects, from new construction to remodels. Our
                    experienced team is dedicated to delivering superior
                    results, on time and on budget.
                  </h2>
                </div>
                <a
                  href="/ContactUs"
                  className="flex w-full sm:w-auto items-center justify-center rounded-xl h-10 px-4 sm:h-12 sm:px-5 bg-[#0d7cf2] text-white text-sm font-bold sm:text-base"
                >
            ...
            <div className="flex flex-col gap-10 px-4 py-10">
              <div className="flex flex-col gap-4">
                <h1 className="text-[#111418] text-2xl font-bold sm:text-3xl md:text-4xl max-w-[720px]">
                  Our Services
                </h1>
                <p className="text-[#111418] text-base max-w-[720px]">
                  The Beejliwala provides a wide range of professional
                  electrical services for commercial and residential clients.
                  From new construction to remodels, upgrades, and repairs, our
                  experienced team is committed to delivering superior results,
